...
/***/ "./src/assets/data/carousel-data.json":
/*!********************************************!*\
  !*** ./src/assets/data/carousel-data.json ***!
  \********************************************/
/*! exports provided: carousel, default */
/***/ (function(module) {

eval("module.exports = {\"carousel\":[{\"pos\":1,\"text\":\"Lorem ipsum dolor sit amet consectetur adipisicing elit, Vitae voluptatum suscipit maxime\",\"image\":\"src/assets/images/image-big.png\"},{\"pos\":2,\"text\":\"Lorem ipsum dolor sit amet consectetur adipisicing elit, Vitae voluptatum suscipit maxime\",\"image\":\"src/assets/images/image-big2.png\"},{\"pos\":3,\"text\":\"Lorem ipsum dolor sit amet consectetur adipisicing elit, Vitae voluptatum suscipit maxime\",\"image\":\"src/assets/images/image-big3.jpg\"}]};\n\n//# sourceURL=webpack:///./src/assets/data/carousel-data.json?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _assets_data_carousel_data_json__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../assets/data/carousel-data.json */ \"./src/assets/data/carousel-data.json\");\nvar _assets_data_carousel_data_json__WEBPACK_IMPORTED_MODULE_0___namespace = /*#__PURE__*/__webpack_require__.t(/*! ../assets/data/carousel-data.json */ \"./src/assets/data/carousel-data.json\", 1);\n/* harmony import */ var _sass_main_scss__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../sass/main.scss */ \"./src/sass/main.scss\");\n/* harmony import */ var _sass_main_scss__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_sass_main_scss__WEBPACK_IMPORTED_MODULE_1__);\n/* harmony import */ var _glidejs_glide__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @glidejs/glide */ \"./node_modules/@glidejs/glide/dist/glide.esm.js\");\n\n\n\n_assets_data_carousel_data_json__WEBPACK_IMPORTED_MODULE_0__.carousel.forEach(function (carouselItem, index) {\n  var bullet = bulletTemplate(index);\n  var template = itemCarouselTemplate(carouselItem);\n  renderCarouselItem(template, '.glide__slides');\n  renderCarouselItem(bullet, '.glide__bullets');\n});\n\nfunction itemCarouselTemplate(carouselItem) {\n  var template = \"\\n    <div class=\\\"glide__slide\\\">\\n        <figure>\\n            <img src=\\\"\".concat(carouselItem.image, \"\\\" />\\n        </figure>\\n        <p class=\\\"slide__text grid\\\">\").concat(carouselItem.text, \"</p>\\n    </div>\");\n  return template;\n}\n\nfunction bulletTemplate(index) {\n  var template = \"<button class=\\\"glide__bullet\\\" data-glide-dir=\\\"=\".concat(index, \"\\\"></button>\");\n  return template;\n}\n\nfunction renderCarouselItem(carouselItem, container) {\n  var $container = document.querySelector(container);\n  $container.innerHTML += carouselItem;\n}\n\nfunction initializeCarousel() {\n  var glide = new _glidejs_glide__WEBPACK_IMPORTED_MODULE_2__[\"default\"]('.glide').mount();\n}\n\ninitializeCarousel();\nvar $hamburguer = document.querySelector('.header__hamburguer');\nvar $header = document.querySelector('.header');\n$hamburguer.addEventListener('click', function (event) {\n  $header.classList.toggle('open-menu');\n});\nvar $menuItem = document.querySelectorAll('.nav__item');\n$menuItem.forEach(function (item) {\n  item.addEventListener('click', function (event) {\n    var clickedItem = event.currentTarget;\n    var sublist = clickedItem.querySelector('.nav__sublist');\n    sublist.classList.toggle('open-submenu');\n  });\n});\n\n//# sourceURL=webpack:///./src/js/index.js?");
...
eval("__webpack_require__(/*! babel-polyfill */\"./node_modules/babel-polyfill/lib/index.js\");\nmodule.exports = __webpack_require__(/*! C:\\Users\\sergioalejandro\\Downloads\\Prueba Desarrollador Jr TITAMEDIA 01 (1)\\prueba\\src\\js\\index.js */\"./src/js/index.js\");\n\n\n//# sourceURL=webpack:///multi_babel-polyfill_./src/js/index.js?");
